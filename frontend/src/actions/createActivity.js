...
export const ACTIVITY_CREATED_CHANGE_TO_FALSE =
    'ACTIVITY_CREATED_CHANGE_TO_FALSE'
export const ERROR_API_VERIF_LOCALISATION_CREATE_ACTIVITY =
...
export const errorApiVerifLocalisationCreateActivity = () => ({
    type: ERROR_API_VERIF_LOCALISATION_CREATE_ACTIVITY,
})
